...
public   class  Grid
    {
        ...
        //    return imgResult;
        //}  
       public static Queue<pictureMode> CreatGrid(int hightKolaz, int widthKolaz, int numPicture, int space,Image [] imageArr)
        {
            return GridResult(hightKolaz, widthKolaz, numPicture, space);
        }
